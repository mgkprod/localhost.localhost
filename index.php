...
<head>
    <title>localhost.localhost️ - Where everything starts.</title>
    <meta charset="utf-8">
...
<body>
    <div class="row align-items-center justify-content-center" id="app">
        <div class="col-md-4">
            ...
            <div class="mb-3">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="50px" height="50px" viewBox="0 0 24 24" enable-background="new 0 0 24 24" xml:space="preserve">
                    <g>
            ...
            <div class="mb-3">
                <h2>localhost<span class="text-muted">.localhost</span></h2>
        ...
        <div class="col-md-4">
            <?php foreach (glob('../*', GLOB_ONLYDIR) as $directory) { ?>
                <?php if ($directory == '.' || $directory == '..' || basename($directory) == 'localhost') continue; ?>
                <a href="https://<?php echo basename($directory); ?>.localhost/" class="text-white">
                    <?php echo basename($directory); ?><span class="text-muted">.localhost</span>
                </a><br>
            <?php } ?>
        </div>
    </div>
